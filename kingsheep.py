...
def main():
    ...
    args.map = u'resources/smalltest.map'
    args.player1module = u'random_player'
    args.player1name = u'RandomPlayer'
    args.player2module = u'random_player'
    args.player2name = u'RandomPlayer'
    args.graphics = False
    args.debug = False
    args.verbosity = 4
